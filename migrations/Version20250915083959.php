 ...
 */
final class Version20250915083959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD COLUMN status VARCHAR(20) NOT NULL DEFAULT \'approved\'');
        // Mettre les utilisateurs existants en 'approved' puisqu'ils sont déjà actifs
    }
