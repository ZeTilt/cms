 ...
 */
final class Version20250915160418 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        , recurrence_end_date DATE DEFAULT NULL, CONSTRAINT FK_3BAE0AA7401B253C FOREIGN KEY (event_type_id) REFERENCES event_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA7EE3A445A FOREIGN KEY (parent_event_id) REFERENCES event (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
